...
import com.example.emart.adaptors.MyCartAdapter;
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                ...
                if(task.isSuccessful()){
                    for(DocumentSnapshot doc : task.getResult().getDocuments()){
                        MyCartModel myCartAllModel = doc.toObject(MyCartModel.class);
                       cartModelList.add(myCartAllModel);
