...
import com.example.emart.adaptors.SliderAdapter;
...
import com.example.emart.databinding.ActivityOnBoardingBinding;
...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    private void addDots(int position) {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            dots[i].setTextSize(35); // You can adjust the text size as needed
